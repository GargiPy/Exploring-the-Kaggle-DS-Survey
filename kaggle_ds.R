...
print(responses$WorkToolsSelect)
...
debate_plot <- debate_tools  %>% 
  ...
  filter(str_detect(WorkToolsSelect,"R") & !str_detect(WorkToolsSelect,"Python")|
...
ggplot(recommendations, aes(language_preference, count, fill = language_preference)) +
  geom_bar(stat = "identity") +
